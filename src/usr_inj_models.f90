...
!!          string to the corresponding injector procedure pointer through a
!!          select-case block, the same way all usr_*_models dispatch files do.
!!          Built-in injector models include
...
!! @details Prepends "inj_" to modelname if not already present, then resolves it
